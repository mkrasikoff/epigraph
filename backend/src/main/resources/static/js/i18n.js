...
const TRANSLATIONS = {
    ru: {
        ...
        // ── Guest landing (TASK-135, shown to unauthenticated visitors / crawlers) ──
        guestHeroTitle:                 'Всё для вашей коллекции цитат',
        guestHeroSubtitle:              'От цитаты дня до статистики и общих подборок с друзьями.',
        guestHeroCta:                   'Начать',
        guestSectionQod:                'Цитата дня',
        guestSectionFav:                'Избранное и теги',
        guestFavDesc:                   'Отмечайте лучшее и раскладывайте цитаты по темам — находите нужное за секунды.',
        guestSectionImport:             'Импорт из книг',
        guestImportDesc:                'Яндекс.Книги, Goodreads и Kindle — перенесите цитаты за пару кликов.',
        guestSectionStats:              'Статистика',
        guestStatsDesc:                 'Наглядная аналитика вашего чтения и коллекции.',
        guestSectionAchievements:       'Достижения',
        guestAchievementsDesc:          'Награды за ежедневные заходы и рост коллекции.',
        guestSectionFriends:            'Друзья',
        guestFriendsDesc:               'Делитесь подборками и следите за коллекциями друзей.',
        guestBullet1:                   'Цитата дня',
        guestBullet2:                   'Импорт из Яндекс.Книг, Goodreads и Kindle',
        guestBullet3:                   'Статистика по вашим цитатам',
        guestBullet4:                   'Бесплатно — начните прямо сейчас',
        guestFeaturesHeading:           'Возможности Epigraph',
        guestSectionShare:              'Публичные ссылки',
        guestShareDesc:                 'Поделитесь цитатой ссылкой — она откроется красивой публичной страницей.',
        guestSectionThemes:             'Темы оформления',
        guestThemesDesc:                'Оформление на любой вкус — в светлой и тёмной версии.',
        guestSectionExport:             'Экспорт цитат',
        guestExportDesc:                'Выгрузите всю коллекцию в файл в любой момент.',
        guestSectionReminders:          'Напоминания',
        guestRemindersDesc:             'Push-уведомление с цитатой дня.',
        guestSectionLanguages:          'Два языка',
        guestLanguagesDesc:             'Русский и английский интерфейс.',
    ...
    en: {
        ...
        // ── Guest landing (TASK-135, shown to unauthenticated visitors / crawlers) ──
        guestHeroTitle:                 'Everything for your quote collection',
        guestHeroSubtitle:              'From a daily quote to stats and shared collections with friends.',
        guestHeroCta:                   'Get started',
        guestSectionQod:                'Quote of the day',
        guestSectionFav:                'Favorites and tags',
        guestFavDesc:                   'Star the best and sort quotes by topic — find what you need in seconds.',
        guestSectionImport:             'Import from books',
        guestImportDesc:                'Yandex Books, Goodreads and Kindle — bring your quotes over in a couple of clicks.',
        guestSectionStats:              'Statistics',
        guestStatsDesc:                 'Clear analytics of your reading and collection.',
        guestSectionAchievements:       'Achievements',
        guestAchievementsDesc:          'Rewards for daily visits and a growing collection.',
        guestSectionFriends:            'Friends',
        guestFriendsDesc:               'Share collections and follow your friends’ collections.',
        guestBullet1:                   'Quote of the day',
        guestBullet2:                   'Import from Yandex Books, Goodreads and Kindle',
        guestBullet3:                   'Statistics on your quotes',
        guestBullet4:                   'Free — start right now',
        guestFeaturesHeading:           'What Epigraph does',
        guestSectionShare:              'Public links',
        guestShareDesc:                 'Share a quote by link — it opens as a clean public page.',
        guestSectionThemes:             'Themes',
        guestThemesDesc:                'A look for every taste — in light and dark.',
        guestSectionExport:             'Export quotes',
        guestExportDesc:                'Download your whole collection to a file anytime.',
        guestSectionReminders:          'Reminders',
        guestRemindersDesc:             'A push notification with the quote of the day.',
        guestSectionLanguages:          'Two languages',
        guestLanguagesDesc:             'Russian and English interface.',
