...
const TRANSLATIONS = {
    ru: {
        ...
        achievementsUnlockedSection:    'Получено',
        achievementsInProgressSection:  'В процессе',
        ...
        achievementFavorites25Desc:     '25 избранных цитат, добавленных вручную',
        achievementAuthors10Title:      'Начитанность',
        achievementAuthors10Desc:       'Цитаты 10 разных авторов, добавленные вручную',
        achievementExplorerTitle:       'Исследователь',
        achievementExplorerDesc:        '5 разных возможностей: добавить цитату, отметить избранное, импортировать, сменить тему, отредактировать профиль',
        achievementWeekStreakTitle:     'Неделя с Epigraph',
        achievementWeekStreakDesc:      '7 дней активности в приложении',
        ...
        badgeBibliophileTitle:          'Библиофил',
        badgeBibliophileDesc:           '45 дней активности',
        badgeKeeperTitle:               'Хранитель',
        badgeKeeperDesc:                '90 дней активности',
        badgeInterpreterTitle:          'Толкователь',
        badgeInterpreterDesc:           '180 дней активности',
    ...
    en: {
        ...
        achievementsInProgressSection:  'In progress',
        ...
        achievementFavorites25Desc:     '25 manually added favorite quotes',
        achievementAuthors10Title:      'Well-read',
        achievementAuthors10Desc:       'Quotes from 10 different manually added authors',
        achievementExplorerTitle:       'Explorer',
        achievementExplorerDesc:        '5 different actions: add a quote, favorite one, import, switch theme, edit your profile',
        achievementWeekStreakTitle:     'A week with Epigraph',
        achievementWeekStreakDesc:      '7 days active in the app',
        ...
        badgeBibliophileTitle:          'Bibliophile',
        badgeBibliophileDesc:           '45 days active',
        badgeKeeperTitle:               'Keeper',
        badgeKeeperDesc:                '90 days active',
        badgeInterpreterTitle:          'Interpreter',
        badgeInterpreterDesc:           '180 days active',
